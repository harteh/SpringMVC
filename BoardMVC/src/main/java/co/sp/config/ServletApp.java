...
import co.sp.interceptor.WriterInterceptor;
...
public class ServletApp implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		//로그인빈 을 등록하여 유저 폴더에 있는 modify, logout, board 폴더 내에 있는 
		//게시판 관련 모든 jsp 메서드 실행 전에 LoginInterceptor 실행되도록 세팅
		//excludePathPatterns -> 메인 화면에서는 실행되지 않도록 배제
